...
$("#start").on("click", function () {
    ...
    function complete () {
        ...
        $("#Game").html('<center><p>All Done!</p></center><br /><p>Correct Answers:  ' + correctAnswers + '</p><p>Incorrect Answers:  ' + incorrectAnswers + '</p><p>Unanswered:  ' + unanswered + '</p>');
    }
...
// Function complete() and have the fx ran when you press I’m finished
