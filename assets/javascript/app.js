...
$("#start").on("click", function () {
    ...
    delayButtonAlert = setTimeout(function () {
        ...
        $("#Game").html('<p>Correct Answers:  ' + correctAnswers + '</p><p>Incorrect Answers:  ' + incorrectAnswers + '</p><p>Unanswered:  ' + unanswered + '</p>');
    // Set X
    }, 
